        ...
        <section className={`relative bg-gradient-to-br ${slides[currentSlide].backgroundGradient} text-white overflow-hidden transition-all duration-1000`}>
            ...
            <div className="relative max-w-7xl mx-auto px-4 py-24 lg:py-32">
                <div className="text-center">
                    ...
                    {/* Slide Content */}
                    <div className={`relative transition-all duration-1000 ${isTransitioning
                            ? slideDirection === 'next'
                        ...
                        <h1 className={`text-5xl md:text-7xl lg:text-8xl font-bold mb-8 leading-tight ${isTransitioning
                                ? 'animate-title-exit'
                                : 'animate-title-enter'
                            }`}>
                            <span className="relative inline-block">
                                {slides[currentSlide].title.split('').map((char, index) => (
                                    <span
                                        key={index}
                                        className={`inline-block bg-gradient-to-r from-white via-blue-100 to-amber-200 bg-clip-text text-transparent ${isTransitioning ? '' : 'animate-text-reveal'
                                            }`}
                                        style={{
                        ...
                        <p className={`text-xl md:text-3xl mb-8 text-blue-100 font-light leading-relaxed max-w-4xl mx-auto overflow-hidden ${isTransitioning
                        ...
                        <p className={`text-lg mb-12 max-w-3xl mx-auto text-blue-50 leading-relaxed ${isTransitioning
                        ...
                        <div className={`flex flex-col sm:flex-row gap-4 justify-center items-center ${isTransitioning
                                ? 'animate-buttons-out'
                                : 'animate-buttons-in'
                            }`}>
                            <Link
                    ...
                    <div className={`mt-16 flex flex-wrap justify-center items-center gap-8 text-blue-200 ${isTransitioning ? 'animate-trust-out' : 'animate-trust-in'
                        }`}>
                    ...
                    <div className="flex space-x-3">
                        {slides.map((_, index) => (
                            <button
                                ...
                                disabled={isTransitioning}
                                className={`relative transition-all duration-500 disabled:cursor-not-allowed ${index === currentSlide
