                ...
                <div className="space-y-2 max-h-60 overflow-y-auto">
                    {categories.slice(0, 15).map((category) => (
                        <button
                            ...
                            className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-all ${currentCategory === category.slug
                ...
                <div className="space-y-2 max-h-48 overflow-y-auto">
                    {countries.slice(0, 12).map((country) => (
                        <button
                            ...
                            className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-all ${currentCountry === country.code
